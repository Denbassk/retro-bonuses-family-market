...
wb = openpyxl.load_workbook(r"D:\РЕТРО_БОНУСЫ Фэмэли маркет\data\справочники\Ассортиментная матрица.xlsx", data_only=True)
ws = wb.active
...
with open(r"D:\РЕТРО_БОНУСЫ Фэмэли маркет\output\matrix_mapping_template.csv", 'w', encoding='utf-8-sig', newline='') as f:
